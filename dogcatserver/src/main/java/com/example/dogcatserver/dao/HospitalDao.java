...
public interface HospitalDao {
    ...
    @Insert("insert into hospital_member(h_username,director,hospital,h_tel,h_reptel,h_address,h_choice,h_location, h_longitude, h_birthday) values(#{hUsername}, #{director},#{hospital}," +
            "#{hTel}, #{hReptel}, #{hAddress},#{hChoice},#{hLocation},#{hLongitude}, #{hBirthDay})")
