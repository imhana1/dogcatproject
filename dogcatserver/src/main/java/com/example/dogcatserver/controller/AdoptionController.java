...
public class AdoptionController {
  ...
  public ResponseEntity<AdoptionDto.Pages> findAllAdoptionByACity(@RequestParam String aCity, @RequestParam(defaultValue = "1") int pageno, @RequestParam(defaultValue = "10") int pagesize) {
