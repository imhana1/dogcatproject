...
public class HMemberManageController {
  ...
  public ResponseEntity<HMemberManageDto.Pages> findAllNotice(@RequestParam(defaultValue = "1") int pageno, @RequestParam(defaultValue = "10") int pagesize) {
  ...
  public ResponseEntity<HMemberManageDto.Pages> findAllHospitalMemberByStatus(@RequestParam(defaultValue = "1") int pageno, @RequestParam(defaultValue = "10") int pagesize, @RequestParam String status) {
  ...
  public ResponseEntity<HMemberManageDto.Pages> findHospitalMemberByWord(@RequestParam(defaultValue = "1") int pageno, @RequestParam(defaultValue = "10") int pagesize, @RequestParam String searchWord, @RequestParam String searchType) {
  ...
  @GetMapping("/api/h-members/n-member")
